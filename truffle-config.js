...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: () => new HDWalletProvider(mnemonic, `https://eth-ropsten.alchemyapi.io/v2/${ETH_ROPSTEN_ALCHEMY_API_KEY}`, 0),
    ...
    rinkeby : {
      provider: () => new HDWalletProvider(mnemonic, `https://eth-rinkeby.alchemyapi.io/v2/${ETH_RINKEBY_ALCHEMY_API_KEY}`, 0),
    ...
    mainnet: {
      provider: () => new HDWalletProvider(mnemonic, `https://eth-mainnet.alchemyapi.io/v2/${ETH_MAINNET_ALCHEMY_API_KEY}`),
      network_id: 1,
